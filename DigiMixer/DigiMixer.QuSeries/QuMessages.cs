...
{
    internal static QuControlMessage RequestControlMessages { get; } = QuControlMessage.Create(type: 4,
    [
    ...
    internal static QuControlMessage RequestFullData { get; } = QuControlMessage.Create(type: 4, [0x02, 0x00]);
    internal static QuControlMessage RequestVersionInformation { get; } = QuControlMessage.Create(type: 4, [0x00, 0x01]);
    internal static QuControlMessage RequestNetworkInformation { get; } = QuControlMessage.Create(type: 4, [0x08, 0x00]);

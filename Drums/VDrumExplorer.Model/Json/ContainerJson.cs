...
namespace VDrumExplorer.Model.Json
{
    ...
    internal class ContainerJson
    {
        ...
        public IContainer ToContainer(ModuleJson module, string name, string description, ModuleAddress address, string? parentPath, SchemaVariables variables)
        {
            ...
            if (Fields is object)
            {
                ...
                return new FieldContainer(name, description, address, path, Size.Value, fieldList);
            ...
            else
            {
                ...
                {
                    containers.AddRange(container.ToContainers(module, address, path, variables));
                }
                return new ContainerContainer(name, description, address, path, containers);
            }
        }
    }
}

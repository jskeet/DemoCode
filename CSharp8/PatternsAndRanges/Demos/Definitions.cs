// This is mostly a copy of the file used by Dustin Campbell and Mads Torgersen at Build 2018.
// Modifications made by Jon have been indicated accordingly
...
namespace System
{
    public readonly struct Index
    {
        ...
        // Start of addition by Jon
        public override string ToString() => $"{Value} from the {(FromEnd ? "end" : "start")}";
        // End of addition
    }
    ...
    static class Extensions
    {
        ...
        // Start of addition by Jon
        public static char get_IndexerExtension(this ReadOnlySpan<char> span, Index index) =>
            index.FromEnd ? span[span.Length - index.Value] : span[index.Value];
        ...
        public static ReadOnlySpan<char> get_IndexerExtension(this ReadOnlySpan<char> span, Range range) =>
            span.Slice(range);
        // End of addition
